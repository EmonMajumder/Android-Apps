...
public class MovieDbHelper extends SQLiteOpenHelper{
    ...
    private void fillmovieTable()
    {
        MovieItem m1 = new MovieItem(1,"NO TIME TO DIE","https://i.ytimg.com/an_webp/ZGSBSRnrCnQ/mqdefault_6s.webp?du=3000&sqp=CLS9r-8F&rs=AOn4CLCv9kalRouzRICwbxAzqkNeWye-GQ","PLOT: Bond has left active service. His peace is short-lived when his old friend Felix " +
                ...
                "\nCAST: Daniel Craig, Rami Malek, Ana de Armas, Léa Seydoux","https://www.youtube.com/watch?v=ZGSBSRnrCnQ",(int)(Math.random()*10+5));
        ...
        MovieItem m2 = new MovieItem(2,"BLACK WIDOW","","PLOT: A film about Natasha Romanoff in her quests between the films Civil War and Infinity War.\n" +
                "CAST: Scarlett Johansson, Florence Pugh, Robert Downey Jr.","https://www.youtube.com/watch?v=R7fIN2juq98",(int)(Math.random()*10+5));

        MovieItem m3 = new MovieItem(3,"The Assistant","","Starring: Julia Garner, Matthew Macfadyen, Makenzie Leigh \n" +
                "Directed By: Kitty Green\n" +
                "Synopsis: A look at the day in the life of the assistant to a powerful corporate executive. ","https://www.youtube.com/watch?v=z9761kQCNWc",(int)(Math.random()*10+5));
        ...
        MovieItem m4 = new MovieItem(4,"Knives Out","","US Release Date: November 27, 2019\n" +
                ...
                "Synopsis: A detective investigates the death of a patriarch of an eccentric, combative family.","https://www.youtube.com/watch?v=xi-1NchUqMA",(int)(Math.random()*10+5));
        ...
        MovieItem m5 = new MovieItem(5,"Pati Patni Aur Woh",""," \"Pati Patni Aur Woh\"  romantic comedy film Directed By Mudassar Aziz and Produced By " +
                ...
                "Ananya Panday in lead roles along with Aparshakti Khurrana in supporting role.","https://www.youtube.com/watch?v=L7a1JSeqaXk",(int)(Math.random()*10+5));
        ...
        MovieItem m6 = new MovieItem(6,"Dark Waters","","Starring: Anne Hathaway, Mark Ruffalo, William Jackson Harper \n" +
                ...
                "https://www.youtube.com/watch?v=jvQUIt0BWcU",(int)(Math.random()*10+5));
        ...
        MovieItem m7 = new MovieItem(7,"Hustlers","","Starring: Jennifer Lopez, Constance Wu, Cardi B\n" +
                ...
                "tables on their Wall Street clients.","https://www.youtube.com/watch?v=LUG2U-IxPx0",(int)(Math.random()*10+5));
        ...
        MovieItem m8 = new MovieItem(8,"Panipat","","PANIPAT is set in 1761, when the Maratha Empire had reached its zenith and their grip on Hindostan " +
                ...
                "https://www.youtube.com/watch?v=zpXnmy-6w1g",(int)(Math.random()*10+5));
        ...
        MovieItem m9 = new MovieItem(9,"21 Bridges","","US Release Date: July 12, 2019\n" +
                ...
                "Synopsis: A disgraced detective in the NYPD is given a shot at redemption.","https://www.youtube.com/watch?v=BVZDhunTrYA",(int)(Math.random()*10+5));
        ...
        MovieItem m10 = new MovieItem(10,"Messiah","","A CIA officer investigates a charismatic figure whose followers believe that he can perform miracles. " +
                "Is he a divine entity or a dangerous con artist?","https://www.youtube.com/watch?v=mjLWuzGVyew",(int)(Math.random()*10+5));

        MovieItem m11= new MovieItem(11,"Mardaani 2","","She's back. She's unstoppable. She is Shivani Shivaji Roy. ",
                "https://www.youtube.com/watch?v=dKeRIOA28Jk",(int)(Math.random()*10+5));
        ...
        MovieItem m12= new MovieItem(12,"ONCE UPON A TIME IN HOLLYWOOD","","Quentin Tarantino’s ONCE UPON A TIME IN HOLLYWOOD visits 1969 Los " +
                ...
                "multiple storylines in a tribute to the final moments of Hollywood’s golden age.","https://www.youtube.com/watch?v=ELeMaP8EPAA",(int)(Math.random()*10+5));
        ...
        MovieItem m13 = new MovieItem(13,"Upgrade","","Starring: Logan Marshall-Green, Rosco Campbell, Richard Cawthorne \n" +
                ...
                "https://www.youtube.com/watch?v=36PDeN9NRZ0",(int)(Math.random()*10+5));

        MovieItem m14= new MovieItem(14,"ROBIBAAR","","Starring : Prosenjit Chatterjee, Jaya Ahsan, Sudipa Basu, Tathagato Banerjee, " +
                "Mithun Debnath, Saswati Sinha and Srijato Banerjee.","https://www.youtube.com/watch?v=H-vUuGBDqQU",(int)(Math.random()*10+5));
        ...
        MovieItem m15= new MovieItem(15,"JUMANJI: THE NEXT LEVEL","","In Jumanji: The Next Level, the gang is back but the game has " +
                ...
                "https://www.youtube.com/watch?v=rBxcF-r9Ibs",(int)(Math.random()*10+5));
        ...
        MovieItem m16= new MovieItem(16,"Pagalpanti","","An Anees Bazmee Film, Presenting the official trailer of the upcoming movie " +
                ...
                "Urvashi Rautela, and Saurabh Shukla.","https://www.youtube.com/watch?v=3-7jehmURuM",(int)(Math.random()*10+5));
        ...
        MovieItem m17= new MovieItem(17,"Parasite","","Bong Joon Ho brings his singular mastery home to Korea in this pitch-black modern " +
                ...
                "to destroy the fragile ecosystem between the Kims and the Parks.","https://www.youtube.com/watch?v=5xH0HfJHsaY",(int)(Math.random()*10+5));
